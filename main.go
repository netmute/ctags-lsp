...
var completionKindByTagKind = map[string]int{
	...
	"functor":          CompletionItemKindModule,
	...
	"group":            CompletionItemKindModule,
	"guard":            CompletionItemKindFunction,
	"handler":          CompletionItemKindFunction,
	"header":           CompletionItemKindFile,
	"icon":             CompletionItemKindValue,
	"id":               CompletionItemKindVariable,
	"implementation":   CompletionItemKindClass,
	"index":            CompletionItemKindValue,
	"infoitem":         CompletionItemKindValue,
	"inline":           CompletionItemKindKeyword,
	"inputSection":     CompletionItemKindKeyword,
	"instance":         CompletionItemKindValue,
	"interface":        CompletionItemKindInterface,
	"it":               CompletionItemKindFunction,
	"integer":          CompletionItemKindValue,
	"jurisdiction":     CompletionItemKindStruct,
	...
	"label":            CompletionItemKindProperty,
	...
	"map":              CompletionItemKindProperty,
	...
	"packageName":      CompletionItemKindModule,
	"param":            CompletionItemKindVariable,
	"parameter":        CompletionItemKindVariable,
	"paramEntity":      CompletionItemKindVariable,
	"part":             CompletionItemKindModule,
	"pattern":          CompletionItemKindKeyword,
	"partition":        CompletionItemKindModule,
	"placeholder":      CompletionItemKindClass,
	"port":             CompletionItemKindField,
	"process":          CompletionItemKindFunction,
	"property":         CompletionItemKindProperty,
	"prototype":        CompletionItemKindFunction,
	"protocol":         CompletionItemKindInterface,
	"provider":         CompletionItemKindModule,
	"publication":      CompletionItemKindValue,
	"qkey":             CompletionItemKindProperty,
	"receiver":         CompletionItemKindVariable,
	"record":           CompletionItemKindStruct,
	"reference":        CompletionItemKindReference,
	"region":           CompletionItemKindModule,
	"register":         CompletionItemKindStruct,
	"repoid":           CompletionItemKindProperty,
	"report":           CompletionItemKindStruct,
	"repositoryId":     CompletionItemKindProperty,
	"repr":             CompletionItemKindStruct,
	"resource":         CompletionItemKindValue,
	"response":         CompletionItemKindValue,
	"role":             CompletionItemKindInterface,
	"rpc":              CompletionItemKindMethod,
	"root":             CompletionItemKindValue,
	"schema":           CompletionItemKindStruct,
	...
	"server":           CompletionItemKindValue,
	"service":          CompletionItemKindInterface,
	"setter":           CompletionItemKindMethod,
	"signal":           CompletionItemKindEvent,
	"singletonMethod":  CompletionItemKindMethod,
	"slot":             CompletionItemKindField,
	"software":         CompletionItemKindStruct,
	"sourcefile":       CompletionItemKindFile,
	"standard":         CompletionItemKindStruct,
	"string":           CompletionItemKindValue,
	"struct":           CompletionItemKindStruct,
	"structure":        CompletionItemKindStruct,
	"stylesheet":       CompletionItemKindFile,
	...
	"subprogspec":      CompletionItemKindFunction,
	"subroutine":       CompletionItemKindFunction,
	"subsection":       CompletionItemKindModule,
	"subst":            CompletionItemKindVariable,
	"substdef":         CompletionItemKindVariable,
	"tag":              CompletionItemKindVariable,
	"talias":           CompletionItemKindStruct,
	"template":         CompletionItemKindVariable,
	"tparam":           CompletionItemKindTypeParameter,
	"test":             CompletionItemKindFunction,
	"theme":            CompletionItemKindValue,
	"theorem":          CompletionItemKindModule,
	"thriftFile":       CompletionItemKindFile,
	"throwsparam":      CompletionItemKindVariable,
	"title":            CompletionItemKindValue,
	"token":            CompletionItemKindFunction,
	"toplevelVariable": CompletionItemKindVariable,
	"trait":            CompletionItemKindInterface,
	"type":             CompletionItemKindStruct,
	"typealias":        CompletionItemKindStruct,
	"typedef":          CompletionItemKindStruct,
	"typespec":         CompletionItemKindStruct,
	"union":            CompletionItemKindStruct,
	"unit":             CompletionItemKindUnit,
	"username":         CompletionItemKindVariable,
	"using":            CompletionItemKindModule,
	...
	"vector":           CompletionItemKindValue,
	"version":          CompletionItemKindValue,
	"video":            CompletionItemKindStruct,
	"view":             CompletionItemKindValue,
	"wrapper":          CompletionItemKindMethod,
	"xdata":            CompletionItemKindStruct,
	"xinput":           CompletionItemKindFile,
	"xtask":            CompletionItemKindFunction,
}
